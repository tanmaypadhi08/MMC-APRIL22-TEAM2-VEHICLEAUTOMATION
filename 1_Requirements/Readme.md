...
|4| Ultrasonic Sensor|The componenet is used to measure the distance of the object placed at a far distance|
|5|STM32F407GDISC|The STM32F407G-DISC1 is a Discovery Kit allows users to easily develop applications with the STM32F407 high performance microcontrollers with ARM cortex-M4 32-bit core.|
|6|220 Ohm resistor|led needs a resistor  of around 100 ohm to 500k ohm|
